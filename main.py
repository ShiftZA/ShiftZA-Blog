...
def register():
    ...
    if form.validate_on_submit():
        ...
        if not auth_user:
            ...
            flash("That email is associated with an account.")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        elif check_password_hash(auth_user.password, form.password.data):
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, current_user=current_user, logged_in=current_user.is_authenticated, year=year)
